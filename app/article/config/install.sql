...
CREATE TABLE `oa_article_cate`  (
  ...
  `pid` int(11) NOT NULL DEFAULT 0 COMMENT '親カテゴリID',
  `sort` int(5) NOT NULL DEFAULT 0 COMMENT 'ソート',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT 'カテゴリタイトル',
  `desc` varchar(1000) NULL DEFAULT '' COMMENT '説明',
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '作成時間',
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新時間',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COMMENT = '知識記事のカテゴリーテーブル';

-- ----------------------------
-- Records of oa_article_cate
-- ----------------------------
INSERT INTO `oa_article_cate` VALUES (1, 0, 0, 'オフィスのテクニック', '', 1637984651, 0);
INSERT INTO `oa_article_cate` VALUES (2, 0, 0, '業界のスキル', '', 1637984739, 0);
...
CREATE TABLE `oa_article`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '知識記事のタイトル',
  `cate_id` int(11) NOT NULL DEFAULT 0 COMMENT '関連するカテゴリーID',
  `keywords` varchar(255) NULL DEFAULT '' COMMENT 'キーワード',
  `desc` varchar(1000) NULL DEFAULT '' COMMENT '概要',
  `thumb` int(11) NOT NULL DEFAULT 0 COMMENT 'サムネイルID',
  `uid` int(11) NOT NULL DEFAULT 0 COMMENT '著者',
  `did` int(11) NOT NULL DEFAULT 0 COMMENT '部門',
  `origin_url` varchar(255) NOT NULL DEFAULT '' COMMENT '元のURL',
  `file_ids` varchar(500) NOT NULL DEFAULT '' COMMENT '関連する添付ファイル',
  `is_share` tinyint(1) NOT NULL DEFAULT 1 COMMENT '共有：0プライベート、1全員、2部門、3個人',
  `share_dids` varchar(500) NOT NULL DEFAULT '' COMMENT '共有部門',
  `share_uids` varchar(500) NOT NULL DEFAULT '' COMMENT '共有ユーザー',
  `content` text NOT NULL COMMENT '記事内容',
  `read` int(11) NOT NULL DEFAULT 0 COMMENT '閲覧数',
  `type` tinyint(2) NOT NULL DEFAULT 0 COMMENT '属性：1重要、2人気、3おすすめ',
  `status` int(1) NOT NULL DEFAULT 1 COMMENT 'ステータス：1正常、-1非公開',
  `sort` int(11) NOT NULL DEFAULT 0 COMMENT 'ソート',
  `create_time` int(11) NOT NULL DEFAULT 0,
  `update_time` int(11) NOT NULL DEFAULT 0,
  `delete_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COMMENT = '知識記事テーブル';
