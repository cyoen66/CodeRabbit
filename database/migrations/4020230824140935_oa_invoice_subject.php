...
class OaInvoiceSubject extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('invoice_subject', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '发票主体名称' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '主体名称',])
