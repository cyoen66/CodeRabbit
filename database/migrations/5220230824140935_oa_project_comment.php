...
class OaProjectComment extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('project_comment', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '项目任务评论表' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('module', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '模块',])
			->addColumn('topic_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => 0,'signed' => false,'comment' => '关联主题id',])
			...
			->addColumn('md_content', 'text', ['limit' => MysqlAdapter::TEXT_REGULAR,'null' => true,'signed' => true,'comment' => 'markdown评论内容',])
