...
class OaWorkCate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('work_cate', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '工作类型' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '工作类型名称',])
