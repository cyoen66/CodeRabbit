...
class OaMeetingCate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('meeting_cate', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '会议室' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '会议室名称',])
