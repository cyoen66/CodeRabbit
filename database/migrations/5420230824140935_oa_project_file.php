...
class OaProjectFile extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('project_file', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '项目任务附件关联表' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
