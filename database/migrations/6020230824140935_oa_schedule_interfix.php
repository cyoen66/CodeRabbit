...
class OaScheduleInterfix extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('schedule_interfix', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '工作记录关联的附件表' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('scid', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => 0,'signed' => false,'comment' => '工作记录ID',])
