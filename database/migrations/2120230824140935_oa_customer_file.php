...
class OaCustomerFile extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('customer_file', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '客户附件关联表' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('customer_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => null,'signed' => false,'comment' => '关联客户id',])
