...
class OaCustomerGrade extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('customer_grade', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '客户等级' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '客户等级名称',])
