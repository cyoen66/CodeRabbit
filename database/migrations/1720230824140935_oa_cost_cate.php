...
class OaCostCate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('cost_cate', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '费用类型' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '费用类型名称',])
