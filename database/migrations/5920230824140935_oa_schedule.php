...
class OaSchedule extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('schedule', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '工作记录' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 255,'null' => false,'default' => '','signed' => true,'comment' => '工作记录主题',])
			->addColumn('cid', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => 1,'signed' => false,'comment' => '预设字段:关联工作内容类型ID',])
			...
			->addColumn('tid', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => 0,'signed' => false,'comment' => '预设字段:关联任务ID',])
			...
			->addColumn('labor_time', 'decimal', ['precision' => 15,'scale' => 2,'null' => false,'default' => 0,'signed' => true,'comment' => '工时',])
			->addColumn('labor_type', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => 0,'signed' => true,'comment' => '工作类型:1案头2外勤',])
