...
class OaIndustry extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('industry', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_0900_ai_ci', 'comment' => '行业' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('title', 'string', ['limit' => 100,'null' => false,'default' => '','signed' => true,'comment' => '行业名称',])
