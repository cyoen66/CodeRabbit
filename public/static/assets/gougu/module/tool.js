  ...
  var tool = {
      ...
      layer.open({
        ...
        success: function (obj, index) {
          var btn =
            '<div data-index="' +
            index +
            '" class="express-close" title="close">閉じる</div>';
          obj.append(btn);
      ...
      layer.open({
        ...
        success: function (obj, index) {
          var btn =
            '<div data-index="' +
            index +
            '" class="express-close" style="display:none;" title="close">閉じる</div>';
          obj.append(btn);
          that.loading = false;
          obj.on("click", ".express-close", function () {
            layer.close(index);
    ...
    open: function (url, width) {
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          var express =
            '<section id="expressLayer" class="express-box" style="width:' +
            sideWidth +
            '"><article id="articleLayer">' +
            res +
            '</article><div id="expressClose" class="express-close" title="close">閉じる</div></section><div id="expressMask" class="express-mask"></div>';
    ...
    ajax: function (options, callback) {
      ...
      if (options.hasOwnProperty("data")) {
        format = options.data.hasOwnProperty("format")
          ? options.data.format
          : "json";
      }
