layui.define([], function (exports) {
	...
	var settings = {
		...
		menu: {
			file: { title: 'ファイル', items: 'preview fullscreen | wordcount' },
			...
			table: { title: '表', items: 'inserttable tableprops deletetable | cell row column' },
		},
		...
		setup: function(editor) {
			console.log("IDが: " + editor.id + " 的编辑器即将初始化.");
		},
