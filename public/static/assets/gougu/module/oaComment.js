	...
	const obj = {
		addLink: function (id, topic_id, module, url, desc) {
			...
			layer.open({
				...
				type: 1,
				area: ['580px', '240px'],
				content: '<div class="px-4 pt-4"><div class="layui-input-inline mr-3">URL</div><div class="layui-input-inline" style="width:500px;"><input type="text" id="box_url" placeholder="URLを入力してください" value="' + url + '" class="layui-input" autocomplete="off" /></div></div><div class="px-4 pt-4"><div class="layui-input-inline mr-3">説明 </div><div class="layui-input-inline" style="width:500px;"><input type="text" id="box_desc" placeholder="リンクの説明を入力してください" value="' + desc + '" class="layui-input" autocomplete="off" /></div></div>',
				btnAlign: 'c',
				btn: ['確定'],
				yes: function () {
